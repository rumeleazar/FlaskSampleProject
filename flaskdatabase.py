...
conn.execute('''CREATE TABLE recipe(id INTEGER  PRIMARY KEY, dishname VARCHAR(100) NOT NULL, description TEXT NOT NULL, ingredients TEXT NOT NULL, directions TEXT NOT NULL, imagename VARCHAR(100) NOT NULL, author VARCHAR(100) NOT NULL) ''')
...
conn.execute('''CREATE TABLE  comments(comments TEXT NOT NULL, id INTEGER NOT NULL, user VARCHAR(100) NOT NULL)''')
